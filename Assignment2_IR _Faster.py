...
mypath="/home/shreemoyee/Desktop/Assign02_IR/20_newsgroups/comp.os.ms-windows.misc"
f=listdir(mypath)
doc_freq={}
term_freq={}
...
import csv
with open('/home/shreemoyee/Desktop/Assign02_IR/20_newsgroups/document_freq.csv', 'w') as csv_file:
...
with open('/home/shreemoyee/Desktop/Assign02_IR/20_newsgroups/term_freq.txt', 'w') as csv_file:
    writer = csv.writer(csv_file)
...
for i in range (df.columns.shape[0]):
    print(i)
    if df.columns[i]=='words':
    	continue
    df[df.columns[i]]=(df['words'].apply(lambda x:term_freq[df.columns[i]][x] if x in term_freq[df.columns[i]].keys() else 0))
...
df.to_csv('/home/shreemoyee/Desktop/Assign02_IR/20_newsgroups/posting_list.csv')
